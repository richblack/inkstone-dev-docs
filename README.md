...
### 📖 動態工具文檔 (Live Docs)
為了確保開發者看到的工具定義與程式碼始終同步，我們提供以下人類可讀的自動化文檔與測試引導：

- **MCP 工具目錄**: [https://dev.finally.click/catalog/](https://dev.finally.click/catalog/) — *展示所有 AI 工具、描述與參數規格。*
- **互動式測試界面**: 請參閱 [Catalog 頁面](https://dev.finally.click/catalog/) 獲取啟動指令，或在終端機執行：`npx @modelcontextprotocol/inspector --sse https://dev.finally.click/sse`
