...
### 📖 動態工具文檔 (Live Docs)
為了確保開發者看到的工具定義與程式碼始終同步，我們提供以下自動生成的人類可讀文檔：

- **MCP 工具目錄**: [https://dev.finally.click/catalog.html](https://dev.finally.click/catalog.html) — *永遠與代碼同步的工具清單。*
- **互動式測試界面**: [透過 Cloudflare MCP Inspector 即時測試](https://mcp-inspector.pages.dev/?url=https://dev.finally.click/sse) — *官方推薦的互動式測試工具。*
